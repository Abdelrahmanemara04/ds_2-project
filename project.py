...
Original file is located at
    https://colab.research.google.com/drive/1QNZ5ObxAeNpIaJWzwftM4K0fStmeHgi5
...
df = pd.read_csv('https://raw.githubusercontent.com/Abdelrahmanemara04/ds_2-project/main/spend_analysis_dataset%20(1).csv')
df.shape
